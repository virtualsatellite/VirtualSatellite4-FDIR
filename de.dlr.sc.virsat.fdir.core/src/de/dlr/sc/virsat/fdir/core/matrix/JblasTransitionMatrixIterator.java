 ...
 *
 */
public class JblasTransitionMatrixIterator extends MatrixIterator {	
	 ...
	 * @param eps epsilon
	 */
	public JblasTransitionMatrixIterator(JblasTransitionMatrix tmTerminal, double[] probabilityDistribution, double delta, double eps) {
