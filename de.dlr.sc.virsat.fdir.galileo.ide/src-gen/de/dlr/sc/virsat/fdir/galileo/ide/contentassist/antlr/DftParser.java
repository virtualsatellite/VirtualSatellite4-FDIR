		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDelayTypeAccess().getGroup(), "rule__DelayType__Group__0");
					...
					put(grammarAccess.getDelayTypeAccess().getTimeAssignment_2(), "rule__DelayType__TimeAssignment_2");
				}
			};
		}
