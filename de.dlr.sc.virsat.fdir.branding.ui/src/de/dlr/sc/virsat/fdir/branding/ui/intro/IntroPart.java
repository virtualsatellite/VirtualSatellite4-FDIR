 ...
 *******************************************************************************/
package de.dlr.sc.virsat.fdir.branding.ui.intro;
...
import de.dlr.sc.virsat.fdir.branding.ui.BrandingPlugin;
...
public class IntroPart implements IIntroPart {
	...
	public void createPartControl(Composite container) {
    	...
    	outerContainer.addListener(SWT.Resize, new Listener() {
    		public void handleEvent(Event event) {
    			...
    			ImageDescriptor backgroundImageDesc = BrandingPlugin.imageDescriptorFromPlugin(BrandingPlugin.PLUGIN_ID, "resources/images/fdir_Welcome.png");
    	...
    	ImageDescriptor loginImageDesc = BrandingPlugin.imageDescriptorFromPlugin(BrandingPlugin.PLUGIN_ID, "resources/images/arrow-48.png");
    	...
    	welcomeText.setText("Welcome to Virtual Satellite FDIR Edition");
    	...
    	startLink.setText("Start modeling FDIR Now!");
	...
	public Image getTitleImage() {
		ImageDescriptor titleDesc = BrandingPlugin.imageDescriptorFromPlugin(BrandingPlugin.PLUGIN_ID, "resources/images/Branding/fdir16.png");
