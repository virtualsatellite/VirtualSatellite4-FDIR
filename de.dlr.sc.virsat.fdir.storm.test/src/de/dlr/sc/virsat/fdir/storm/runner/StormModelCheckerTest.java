...
public class StormModelCheckerTest {
	...
	public void testCheckModel() {
		...
		assertEquals(EXPECTED_MTTF, modelChecker.getMeanTimeToFailure(), DELTA);
		assertEquals(EXPECTED_FAIL_RATES, modelChecker.getFailRates());
	}
	...
	public void testSteadyStateAvailability() {
		...
		modelChecker.checkModel(ma, SteadyStateAvailability.STEADY_STATE_AVAILABILITY);
		
		final double DELTA = 0.01;
		assertEquals(EXPECTED_STEADY_STATE_AVAILABILITY, modelChecker.getSteadyStateAvailability(), DELTA);
	}
}