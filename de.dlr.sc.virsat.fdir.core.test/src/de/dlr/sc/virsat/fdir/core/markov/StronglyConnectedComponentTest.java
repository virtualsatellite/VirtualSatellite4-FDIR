...
public class StronglyConnectedComponentTest {
	...
	public void testGetStronglyConnectedComponents() {
		...
		List<StronglyConnectedComponent<MarkovState>> sccs = StronglyConnectedComponent.getStronglyConnectedComponents(ma);
		...
		List<StronglyConnectedComponent<MarkovState>> endSccs = StronglyConnectedComponent.getStronglyConnectedEndComponents(ma);
