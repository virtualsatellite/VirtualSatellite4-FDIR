 ...
 * 
 */
public class UiSnippetSectionRecoveryAutomaton extends AUiSnippetSectionRecoveryAutomaton implements IUiSnippet {
	@Override
	public void createSwt(FormToolkit toolkit, EditingDomain editingDomain, Composite composite, EObject initModel) {
		...
		Button buttonUpdate = toolkit.createButton(buttonSectionBody, "Minimize Automata", SWT.PUSH);
		buttonUpdate.addSelectionListener(new SelectionListener() {
			...
			public void widgetDefaultSelected(SelectionEvent e) {
				...
				Job job = new Job("Minimize Automata") {
					...
					protected IStatus run(IProgressMonitor monitor) {
						...
						editingDomain.getCommandStack().execute(recAutomatonMinimizeCommand);
