 ...
 * 
 */	
public abstract class AAddMCSAnalysisHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddMCSAnalysisCommand().create(editingDomain, owner, activeConcept);
	}
}
