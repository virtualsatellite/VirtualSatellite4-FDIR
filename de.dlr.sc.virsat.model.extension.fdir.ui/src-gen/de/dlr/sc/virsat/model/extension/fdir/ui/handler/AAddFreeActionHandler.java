 ...
 * 
 */	
public abstract class AAddFreeActionHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddFreeActionCommand().create(editingDomain, owner, activeConcept);
	}
}
