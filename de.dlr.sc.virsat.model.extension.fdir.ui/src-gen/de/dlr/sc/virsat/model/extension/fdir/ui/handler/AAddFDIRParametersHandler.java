 ...
 * 
 */	
public abstract class AAddFDIRParametersHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddFDIRParametersCommand().create(editingDomain, owner, activeConcept);
	}
}
