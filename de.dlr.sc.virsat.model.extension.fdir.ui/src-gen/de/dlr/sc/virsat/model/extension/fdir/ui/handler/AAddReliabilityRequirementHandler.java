 ...
 * 
 */	
public abstract class AAddReliabilityRequirementHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddReliabilityRequirementCommand().create(editingDomain, owner, activeConcept);
	}
}
