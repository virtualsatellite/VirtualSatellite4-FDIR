 ...
 * 
 */	
public abstract class AAddFaultHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddFaultCommand().create(editingDomain, owner, activeConcept);
	}
}
