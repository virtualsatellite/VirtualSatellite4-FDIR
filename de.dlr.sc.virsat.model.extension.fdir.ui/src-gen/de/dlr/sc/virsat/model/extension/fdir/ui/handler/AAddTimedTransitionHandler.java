 ...
 * 
 */	
public abstract class AAddTimedTransitionHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddTimedTransitionCommand().create(editingDomain, owner, activeConcept);
	}
}
