 ...
 * 
 */	
public abstract class AAddReliabilityAnalysisHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddReliabilityAnalysisCommand().create(editingDomain, owner, activeConcept);
	}
}
