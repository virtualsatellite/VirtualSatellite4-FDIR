 ...
 * 
 */	
public abstract class AAddFaultTreeEdgeHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddFaultTreeEdgeCommand().create(editingDomain, owner, activeConcept);
	}
}
