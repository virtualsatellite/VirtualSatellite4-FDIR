 ...
 * 
 */	
public abstract class AAddOBSERVERHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddOBSERVERCommand().create(editingDomain, owner, activeConcept);
	}
}
