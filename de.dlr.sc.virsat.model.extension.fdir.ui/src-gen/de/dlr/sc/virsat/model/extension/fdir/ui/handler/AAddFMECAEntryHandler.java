 ...
 * 
 */	
public abstract class AAddFMECAEntryHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddFMECAEntryCommand().create(editingDomain, owner, activeConcept);
	}
}
