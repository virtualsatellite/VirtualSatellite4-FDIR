 ...
 * 
 */	
public abstract class AAddRecoveryAutomatonGenHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddRecoveryAutomatonGenCommand().create(editingDomain, owner, activeConcept);
	}
}
