...
import de.dlr.sc.virsat.model.extension.fdir.ui.command.CreateAddPDEPCommand;
 ...
 * 
 */	
public abstract class AAddPDEPHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddPDEPCommand().create(editingDomain, owner, activeConcept);
	}
}
