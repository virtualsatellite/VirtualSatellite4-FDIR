 ...
 * 
 */	
public abstract class AAddRepairActionHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddRepairActionCommand().create(editingDomain, owner, activeConcept);
	}
}
