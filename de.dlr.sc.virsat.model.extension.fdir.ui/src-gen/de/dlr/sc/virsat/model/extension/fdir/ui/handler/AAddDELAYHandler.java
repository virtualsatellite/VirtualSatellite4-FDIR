 ...
 * 
 */	
public abstract class AAddDELAYHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddDELAYCommand().create(editingDomain, owner, activeConcept);
	}
}
