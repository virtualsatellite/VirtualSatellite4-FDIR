 ...
 * 
 */	
public abstract class AAddFDEPHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddFDEPCommand().create(editingDomain, owner, activeConcept);
	}
}
