 ...
 * 
 */	
public abstract class AAddCriticalityVectorHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddCriticalityVectorCommand().create(editingDomain, owner, activeConcept);
	}
}
