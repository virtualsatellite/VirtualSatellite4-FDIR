 ...
 * 
 */	
public abstract class AUiSnippetTableFaultTreeGatesOBSERVER extends AUiSnippetArrayInstanceCategoryTable implements IUiSnippet {

	public AUiSnippetTableFaultTreeGatesOBSERVER() {
	...
	protected Command createAddCommand(EditingDomain editingDomain, Concept activeConcept) {
		return new CreateAddArrayElementGatesCommand().create(editingDomain, getArrayInstance(model),  ActiveConceptHelper.getCategory(activeConcept, "OBSERVER"));
	}
}
