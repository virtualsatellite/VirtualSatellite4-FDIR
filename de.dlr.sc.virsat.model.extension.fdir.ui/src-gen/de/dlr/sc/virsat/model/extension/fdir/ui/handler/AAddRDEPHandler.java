 ...
 * 
 */	
public abstract class AAddRDEPHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddRDEPCommand().create(editingDomain, owner, activeConcept);
	}
}
