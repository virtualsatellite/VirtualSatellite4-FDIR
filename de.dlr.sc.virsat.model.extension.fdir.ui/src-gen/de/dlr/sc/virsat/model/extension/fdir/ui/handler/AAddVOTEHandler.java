 ...
 * 
 */	
public abstract class AAddVOTEHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddVOTECommand().create(editingDomain, owner, activeConcept);
	}
}
