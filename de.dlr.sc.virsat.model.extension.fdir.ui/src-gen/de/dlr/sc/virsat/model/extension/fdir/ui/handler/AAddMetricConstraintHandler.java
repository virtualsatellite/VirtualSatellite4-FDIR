 ...
 * 
 */	
public abstract class AAddMetricConstraintHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddMetricConstraintCommand().create(editingDomain, owner, activeConcept);
	}
}
