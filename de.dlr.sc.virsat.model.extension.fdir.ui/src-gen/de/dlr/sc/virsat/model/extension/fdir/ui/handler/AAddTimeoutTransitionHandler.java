 ...
 * 
 */	
public abstract class AAddTimeoutTransitionHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddTimeoutTransitionCommand().create(editingDomain, owner, activeConcept);
	}
}
