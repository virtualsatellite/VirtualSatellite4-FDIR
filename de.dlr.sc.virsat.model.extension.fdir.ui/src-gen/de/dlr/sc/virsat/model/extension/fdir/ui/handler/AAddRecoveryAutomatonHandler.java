 ...
 * 
 */	
public abstract class AAddRecoveryAutomatonHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddRecoveryAutomatonCommand().create(editingDomain, owner, activeConcept);
	}
}
