 ...
 * 
 */	
public abstract class AAddFMECAHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddFMECACommand().create(editingDomain, owner, activeConcept);
	}
}
