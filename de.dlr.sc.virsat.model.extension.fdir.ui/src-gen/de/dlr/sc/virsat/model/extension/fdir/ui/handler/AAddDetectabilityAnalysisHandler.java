 ...
 * 
 */	
public abstract class AAddDetectabilityAnalysisHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddDetectabilityAnalysisCommand().create(editingDomain, owner, activeConcept);
	}
}
