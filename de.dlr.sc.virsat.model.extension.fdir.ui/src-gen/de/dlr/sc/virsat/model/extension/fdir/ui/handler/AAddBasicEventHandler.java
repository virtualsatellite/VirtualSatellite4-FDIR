 ...
 * 
 */	
public abstract class AAddBasicEventHandler extends ATransactionalAddCategoryHandler {
	...
	protected Command createAddCommand(EditingDomain editingDomain, EObject owner, Concept activeConcept) {
		return new CreateAddBasicEventCommand().create(editingDomain, owner, activeConcept);
	}
}
