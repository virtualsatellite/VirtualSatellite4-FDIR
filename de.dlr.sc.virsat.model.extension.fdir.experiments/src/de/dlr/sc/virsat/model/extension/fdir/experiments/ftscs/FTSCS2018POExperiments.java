...
public class FTSCS2018POExperiments extends ASynthesizerExperiment {
	...
	public void experimentMultiProcessorSystem() throws Exception {
		...
		saveRA(ra, "ftscs/obsMcs/original");
		...
		saveRA(partitionRefinementMinimized, "ftscs/obsMcs/traceEquivalenceRule");
		...
		saveRA(fsMinimized, "ftscs/obsMcs/finalStateRule");
		...
		saveRA(fsMinimized, "ftscs/obsMcs/orthogonalRule");
		...
		saveRA(fsMinimized, "ftscs/obsMcs/composedRules");
