 ...
 * 
 */	
public abstract class AMONITOR extends Gate implements IBeanCategoryAssignment {

	public static final String FULL_QUALIFIED_CATEGORY_NAME = "de.dlr.sc.virsat.model.extension.fdir.MONITOR";
	...
	public AMONITOR(Concept concept) {
		Category categoryFromActiveCategories = ActiveConceptHelper.getCategory(concept, "MONITOR");
		CategoryAssignment categoryAssignement = new CategoryInstantiator().generateInstance(categoryFromActiveCategories, "MONITOR");
		setTypeInstance(categoryAssignement);
	}
	
	public AMONITOR(CategoryAssignment categoryAssignement) {
		setTypeInstance(categoryAssignement);
	}
