...
public interface IDFTEvent {
	 ...
	 */
	double getRate(ExplicitDFTState state);
	 ...
	 */
	boolean canOccur(ExplicitDFTState state);
	 ...
	 */
	void execute(ExplicitDFTState state, Set<BasicEvent> orderDependentBasicEvents, Set<FaultTreeNode> transientNodes);
