 ...
 *******************************************************************************/
package de.dlr.sc.virsat.model.extension.fdir.marker;
 ...
 *
 */
public class VirSatFDIRMarkerHelper extends VirSatValidationMarkerHelper implements IMarkerHelper {
	
	static final String ID_FDIR_VALIDATION_PROBLEM_MARKER = "de.dlr.sc.virsat.problem.markers.validation.fdir";
	 ...
	 *		 		L___ ...
	 * 				|
	 * 				L___ FDIR_VALIDATION_PROBLEM_MARKER
	 */		
	
	@Override
	protected String getMarkerID() {
		return ID_FDIR_VALIDATION_PROBLEM_MARKER;
	}
	...
	public boolean isAssociatedWith(IMarker marker, EObject eObject) {
		...
		try {
			if (marker.isSubtypeOf(ID_FDIR_VALIDATION_PROBLEM_MARKER) && eObject instanceof IUuid) {
	...
	/**
	 * Method to attach a FDIRValidationProblemMarker to the Resource of the given object
	...
	/**
	 * Method to attach a FDIRValidationProblemMarker to the common Resource of the given objects
	 * @param severity A Severity Level to be displayed with the Marker
	 * @param message A Message to be displayed in the Problem View
	 * @param iUuid An eObject on which the Problem actually occurred.
	 ...
	 * @return The created Marker
	 */
	public IMarker createFDIRValidationMarker(int severity, String message, IUuid iUuid, IUuid secondIUuid) {
