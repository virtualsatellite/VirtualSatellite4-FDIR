...
public class OrthogonalPartitionRefinementMinimizerTest extends AMinimizerTestCase {

	@Override
	public ARecoveryAutomatonMinimizer createMinimizer() {
		return new OrthogonalPartitionRefinementMinimizer();
	}
	...
	public void testMergeTwoOrthogonal() {
		...
		recoveryAutomatonHelper.assignInputs(transition01, fault2);
		recoveryAutomatonHelper.assignInputs(transition02, fault1);
		recoveryAutomatonHelper.assignInputs(transition13, fault1);
	...
	public void testMergeThreeOrthogonal() {
		...
		FaultEventTransition transition14 = recoveryAutomatonHelper.createFaultEventTransition(ra, ra.getStates().get(1), ra.getStates().get(4));
		FaultEventTransition transition24 = recoveryAutomatonHelper.createFaultEventTransition(ra, ra.getStates().get(2), ra.getStates().get(4));
		FaultEventTransition transition34 = recoveryAutomatonHelper.createFaultEventTransition(ra, ra.getStates().get(3), ra.getStates().get(4));
		...
		recoveryAutomatonHelper.assignInputs(transition01, fault1);
		recoveryAutomatonHelper.assignInputs(transition02, fault2);
		recoveryAutomatonHelper.assignInputs(transition03, fault3);
		recoveryAutomatonHelper.assignInputs(transition14, fault2);
		recoveryAutomatonHelper.assignInputs(transition24, fault1);
		recoveryAutomatonHelper.assignInputs(transition34, fault1);
		
		recoveryAutomatonHelper.assignInputs(transition11, fault1);
		recoveryAutomatonHelper.assignInputs(transition22, fault2);
		recoveryAutomatonHelper.assignInputs(transition33, fault2);
		...
		recoveryAutomatonHelper.assignAction(transition01, recoveryAutomatonHelper.copyClaimAction(action1));
		recoveryAutomatonHelper.assignAction(transition02, recoveryAutomatonHelper.copyClaimAction(action1));
		recoveryAutomatonHelper.assignAction(transition03, recoveryAutomatonHelper.copyClaimAction(action1));
		recoveryAutomatonHelper.assignAction(transition14, recoveryAutomatonHelper.copyClaimAction(action1));
		recoveryAutomatonHelper.assignAction(transition24, recoveryAutomatonHelper.copyClaimAction(action1));
		recoveryAutomatonHelper.assignAction(transition34, recoveryAutomatonHelper.copyClaimAction(action1));
