...
public class DftGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class GalileoNodeTypeElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cDelayTypeParserRuleCall_3 = (RuleCall)cAlternatives.eContents().get(3);
		
		//GalileoNodeType:
		//	NamedType | ObserverType | RDEPType | DelayType;
		@Override public ParserRule getRule() { return rule; }
		...
		//DelayType
		public RuleCall getDelayTypeParserRuleCall_3() { return cDelayTypeParserRuleCall_3; }
	}
	...
	public class DelayTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "de.dlr.sc.virsat.fdir.galileo.Dft.DelayType");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//DelayType GalileoNodeType:
		//	'delay' 'time' time=Float;
		@Override public ParserRule getRule() { return rule; }
	...
	private final DelayTypeElements pDelayType;
	...
	public DftGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pDelayType = new DelayTypeElements();
	...
	public ParserRule getDelayTypeRule() {
